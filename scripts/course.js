document.addEventListener("DOMContentLoaded", () => {
    ...
    // Close dialog when clicking close button or backdrop
    ...
    function updateCredits(filter) {
        const totalCredits = Array.from(document.querySelectorAll(".course"))
            ...
            .reduce((sum, course) => {
                return sum + parseInt(course.getAttribute("data-credits"), 10);
            }, 0);

        document.getElementById("totalCreditsCert01").innerHTML = 
